...
$routes = [
    ...
    'asset' => [static fn () => PublicSite::asset($params), false],
    ...
    'mockup_asset' => [Admin::mockupAsset(...), true],
...
$prospectFacing = ['mockup', 'shot', 'asset', 'portrait', 'track_open', 'track_click', 'unsubscribe', 'interest', 'cron'];
